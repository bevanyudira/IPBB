...
export interface SpopFormData extends FieldValues {
    ...
    KD_PROPINSI_BERSAMA?: string;
    KD_DATI2_BERSAMA?: string;
    KD_KECAMATAN_BERSAMA?: string;
    KD_KELURAHAN_BERSAMA?: string;
    KD_BLOK_BERSAMA?: string;
    NO_URUT_BERSAMA?: string;
    KD_JNS_OP_BERSAMA?: string;
    
    // === DATA TRANSAKSI ASAL (CONDITIONAL - Optional dulu) ===
    KD_PROPINSI_ASAL?: string;
    KD_DATI2_ASAL?: string;
    KD_KECAMATAN_ASAL?: string;
    KD_KELURAHAN_ASAL?: string;
    KD_BLOK_ASAL?: string;
    NO_URUT_ASAL?: string;
    KD_JNS_OP_ASAL?: string;
